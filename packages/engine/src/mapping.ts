 ...
 */
export const CHARACTER_MAP: ReadonlyMap<PotentialTypeId, CharacterInfo> = new Map<
  PotentialTypeId,
  CharacterInfo
>([
  [
 ...
 */
export function getCharacterName(typeId: PotentialTypeId, style: "male" | "female"): string {
