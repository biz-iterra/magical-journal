...
function buildSystem(): string {
  return [
    ...
    "- 断定的な決めつけは避けるが、**同じ結びを繰り返さない**。",
    "  「〜な傾向があります」は6項目のうち多くても1回まで。",
    "  «〜しやすいタイプです / 〜が持ち味です / 〜する場面が多いようです / 〜を得意とします /",
    "  〜と相性がよさそうです / 〜が活きてきます» のように結びを変えて、読み物として単調にしない。",
    "- 句読点は全角の「。」「、」で統一する。半角のピリオド(.)やカンマ(,)を文末に使わない。",
