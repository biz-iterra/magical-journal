...
export const API_ERRORS = {
  ...
  // ── リクエスト共通 ──────────────────────────────────────
  "MJ-REQ-001": { status: 400, message: "リクエストの形式が不正です" },
  ...
  "MJ-REG-005": { status: 400, message: "住所の位置情報が不正です" },
  "MJ-REG-006": { status: 400, message: "お名前はかなで入力してください" },
  ...
  "MJ-PROF-003": { status: 400, message: "住所の位置情報が不正です" },
